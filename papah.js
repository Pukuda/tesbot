...
const tahunBaru = new Date('January 1, 2024 00:00:00')
        ...
        const idulFitri = new Date('April 20, 2023 00:00:00')
        ...
        const idulAdha = new Date('Juni 28, 2023 00:00:00')
        ...
        const UltahCreator = new Date('Mei 7, 2023 00:00:00')
...
const nyoutube = ('© NaxyBot\nCreator :\nwa.me/6283826733522')  //ubah di config biar ngk emror
const apikeynya = ('Apikey Costum')
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            await papah.sendButtonText(m.chat, jawab, `${text.split("|")[1]}`, m, {quoted: ftoko})
            }
            break
            case 'bisakah': {
...
//PEMBATAS ADMIN & OWNER=======================================
            ...
            case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                papah.sendMessage(m.chat, { image: fs.readFileSync('./media/image/donasi.jpg'), caption: `*${ucapanWaktu} Kak ${m.pushName}*\n\n *Jika ingin berdonasi silahkan scan gambar diatas*\n\n*Jika ingin sewa bot atau premium*\n*Silahkan Chat Owner*\n\n*Atau Transfer via*\n- *Gopay Dana Ovo*\n Ke nomer berikut : 083867371683\n\n_Terima kasih_` }, { quoted: m })
            }
            break
            case 'sc': {
                m.reply('Mau cari apa bg?')
            }
            break		 
            ...
            await papah.sendButtonText(ownernya, pjtxt, nyoutube, m, {mentions: ments, quoted: fdoc})
            let akhji = `*Request Telah Terkirim*\n*Ke Owner @${ownernya.split('@')[0]}*\n_Terima Kasih🙏_`
            await papah.sendButtonText(m.chat, akhji, nyoutube, m, {mentions: ments, quoted: fkontak})
            }
            break
            case 'myip': {
                if (!isCreator) throw mess.owner
            ...
            await papah.sendButtonText(m.chat, jawab, nyoutube, m, {mentions: ments, quoted: fkontak})
            }
            break
            case 'react': {
                if (!isCreator) throw mess.owner
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            case 'report': case 'lapor': {
               ...
               let pjtxt = `Pesan Dari : @${me.split('@')[0]} \nUntuk : @${ownernya.split('@')[0]}\n\n${text}`
               let ments = [ownernya, me]
            await papah.sendButtonText(ownernya, pjtxt, nyoutube, m, {mentions: ments})
            let akhji = `Laporan Telah Terkirim\nKe Owner @${ownernya.split('@')[0]}\n*Terima Kasih Laporannya🙏*\n_Nomermu Akan Terblokir_\n_Jika Laporan Hanya Di Buat Buat_`
            await papah.sendButtonText(m.chat, akhji, nyoutube, m, {mentions: ments})
            }
            break
            case 'hehehe': {
                reactionMessage = {
...
await papah.sendButtonText(i, txt, nyoutube, m, {quoted: fkontak})
}
...
m.reply(`Mengirim Broadcast Ke ${anu.length} Chat\nWaktu Selesai ${anu.length * 1.5} detik`)
		...
		await sleep(1500)
		let txt = `「 Broadcast Bot 」\n\n${text}`
            await papah.sendButtonText(yoi, txt, nyoutube, m, {quoted: fkontak})
		}
...
await papah.sendButtonText(m.chat, teks, nyoutube, m, {mentions: [i.userJid], quoted: fkontak})
}}
break
            case 'q': case 'quoted': {
        try {
            ...
            case 'listpc': {
            	if (!isCreator) throw mess.owner
                 ...
                 for (let i of anu) {
                     ...
                     teks += `⬡ *Nama :* ${nama}\n⬡ *User :* @${i.split('@')[0]}\n\n───────────────\n\n`
await papah.sendButtonText(m.chat, teks, nyoutube, m, {mentions: [i], quoted: fkontak})
}}
             break
                case 'listgc': {
                	if (!isCreator) throw mess.owner
...
await papah.sendButtonText(m.chat, teks, nyoutube, m, {mentions: [metadata.owner], quoted: fkontak})
}}
             break
...
break
	...
	case 'menfes': case 'menfess': {
            ...
            await papah.sendButtonText(m1 + '@s.whatsapp.net', pjtxt, kawk, m, {mentions: ments, quoted: kafloc})
...
break
case 'bucinstik': case 'bucin' : case 'slove': {
...
break
case 'lonet':
papah.sendMessage(m.chat, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/lonte?apikey=Apikey Costum`}}, {quoted: m})
break
case 'lidi':
papah.sendMessage(m.chat, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/manusia-lidi?apikey=Apikey Costum`}}, {quoted: m})
break
case 'kucing':
papah.sendMessage(m.chat, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/kucing?apikey=Apikey Costum`}}, {quoted: m})
break
case 'sponbob':
papah.sendMessage(m.chat, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/sponsbob?apikey=Apikey Costum`}}, {quoted: m})
break
case 'kawansponbob':
papah.sendMessage(m.chat, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/kawan-sponsbob?apikey=Apikey Costum`}}, {quoted: m})
break
case 'popoci':
papah.sendMessage(m.chat, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/popoci?apikey=Apikey Costum`}}, {quoted: m})
break
case 'meow':
papah.sendMessage(m.chat, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/meow?apikey=Apikey Costum`}}, {quoted: m})
break
case 'menjamet':
papah.sendMessage(m.chat, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/menjamet?apikey=Apikey Costum`}}, {quoted: m})
break
case 'tyni':
papah.sendMessage(m.chat, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/tyni?apikey=Apikey Costum`}}, {quoted: m})
break
case 'gojosatoru':
papah.sendMessage(m.chat, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/gojosatoru?apikey=Apikey Costum`}}, {quoted: m})
break
case 'hopeboy':
papah.sendMessage(m.chat, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/hope-boy?apikey=Apikey Costum`}}, {quoted: m})
break
case 'doge':
papah.sendMessage(m.chat, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/doge?apikey=Apikey Costum`}}, {quoted: m})
break
case 'dinokuning':
papah.sendMessage(m.chat, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/dyno-kuning?apikey=Apikey Costum`}}, {quoted: m})
break
case 'nicholas':
papah.sendMessage(m.chat, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/nicholas?apikey=Apikey Costum`}}, {quoted: m})
break
case 'krrobot':
papah.sendMessage(m.chat, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/kr-robot?apikey=Apikey Costum`}}, {quoted: m})
break
case 'jiisho':
papah.sendMessage(m.chat, {sticker: {url: `https://api.zeeoneofc.xyz/api/telegram-sticker/jisoo?apikey=Apikey Costum`}}, {quoted: m})
break
case 'cecanvietnam':
				papah.sendMessage(m.chat, { caption: "Random Cecan Vietnam", image: { url: `https://api.zeeoneofc.xyz/api/cecan/vietnam?apikey=Apikey Costum` }, footer: 'Mau foto selanjutnya? Ketik ${prefix} cecanvietnam' }, { quoted: m })
				break
case 'cecanmalaysia':
				papah.sendMessage(m.chat, { caption: "Random Cecan Malaysia", image: { url: `https://api.zeeoneofc.xyz/api/cecan/malaysia?apikey=Apikey Costum` }, footer: 'Mau foto selanjutnya? Ketik ${prefix} cecanmalaysia' }, { quoted: m })
				break
case 'cecanindonesia':
				papah.sendMessage(m.chat, { caption: "Random Cecan Indonesia", image: { url: `https://api.zeeoneofc.xyz/api/cecan/indonesia?apikey=Apikey Costum` }, footer: 'Mau foto selanjutnya? Ketik ${prefix} cecanindonesia' }, { quoted: m })
				break
case 'cecankorea':
				papah.sendMessage(m.chat, { caption: "Random Cecan Korea", image: { url: `https://api.zeeoneofc.xyz/api/cecan/korea?apikey=Apikey Costum` }, footer: 'Mau foto selanjutnya? Ketik ${prefix} cecankorea' }, { quoted: m })
				break
case 'cecanjapan':
				papah.sendMessage(m.chat, { caption: "Random Cecan Japan", image: { url: `https://api.zeeoneofc.xyz/api/cecan/japan?apikey=Apikey Costum` }, footer: 'Mau foto selanjutnya? Ketik ${prefix} cecanjapan' }, { quoted: m })
				break
case 'cecanthailand':
				papah.sendMessage(m.chat, { caption: "Random Cecan Thailand", image: { url: `https://api.zeeoneofc.xyz/api/cecan/thailand?apikey=Apikey Costum` }, footer: 'Mau foto selanjutnya? Ketik ${prefix} cecanthailand' }, { quoted: m })
				break
case 'cecanchina':
				papah.sendMessage(m.chat, { caption: "Random Cecan China", image: { url: `https://api.zeeoneofc.xyz/api/cecan/china?apikey=Apikey Costum` }, footer: 'Mau foto selanjutnya? Ketik ${prefix} cecanchina' }, { quoted: m })
...
break
            case 'waifu': {
                ...
                await papah.sendButtonText(m.chat, tesk, nyoutube, m, {quoted: fkontak})
            	}
            break
            case 'sfw': {
...
//============================================//
           case 'kisahnabi': {
          if (!text) throw 'Masukkan Query Nabi'
                  let kisah = await fetchJson(`http://api.lannn.me/api/muslim/kisahnabi?nabi=${text}&apikey=VCMQpXyQ`)
                  let nabi = `🍃 Kisah Nabi ${text}\n\n📮 Nama : ${kisah.result.name}\n🔖 Lahir : ${kisah.result.kelahiran}\n🏨 Wafat : ${kisah.result.wafat_usia}\n🎑 Singgah : ${kisah.result.kisah}\n🔎 Cerita : ${kisah.result.kisah}\n`
m.reply(nabi)
}
break
//Pembatas Maker========================================
...
papah.sendMessage(m.chat, { caption: 'Kamu bisa mengubahnya menjadi Vidio Tanpa Watermark atau Audio, ketik ${prefix} tiktoknowm atau ${prefix} tiktokaudio untuk mengubahnya!', video: { url: data.watermark }, footer: `© NaxyBot`, mentions: [sender] })
})
}
break
            case 'tiktoknowm':{
...
-Creator :  @${ownernya.split('@')[0]}\n-Lu : @${me.split('@')[0]}\n-Powered  : @${ini_mark.split('@')[0]}\n- :  @${qontak.split('@')[0]}\n- :  @${dana.split('@')[0]}\n- :  @${shopeeotp.split('@')[0]}\n- :  @${shopee.split('@')[0]}\n- :  @${tokopedia.split('@')[0]}\n- :  @${smartfrend.split('@')[0]}\n- :  @${getcontact.split('@')[0]}\n- :  @${facebook.split('@')[0]}\n- :  @${pasarpolis.split('@')[0]}\n- :  @${getcontact.split('@')[0]}\n- :  @${kominfo.split('@')[0]}\n- :  @${alfamart.split('@')[0]}`
            let ments = [ownernya, me, ini_mark, qontak, dana, shopeeotp, shopee, tokopedia, smartfrend, getcontact, facebook, pasarpolis, kominfo, alfamart]
                    await papah.sendButtonText(m.chat, jawab, papah.user.name, m, {mentions: ments})
            }
            break
            case 'menu': {
            let ownernya = ownernomer + '@s.whatsapp.net'
...
╭––『 𝙍𝙐𝙇𝙀𝙎 𝘽𝙊𝙏 』
┆
┆ NaxyBot merupakan sebuah Robot
┆ WhatsApp yang diprogram untuk
┆ melakukan perintah tertentu secara
┆ otomatis.
┆ Setiap respon atau balasan yang
┆ dilakukan oleh bot bukan dari Manusia.
┆
┆ Dengan memakai bot ini maka kamu
┆ *setuju* dengan syarat dan kondisi sbg
┆ berikut:
...
┆❏ Kami sama sekali tidak menyimpan
┆ data pribadi kamu di server.
┆❏ Kami tidak bertanggung jawab atas
┆ perintah kamu kepada bot ini.
┆❏ Dilarang Keras Call/Vc Bot.
╰–––––––––––––––༓
`
...
│
╰─────❍`
            await papah.sendButtonText(m.chat, goup, nyoutube, m, {quoted: fkontak})
            }
            break
      case 'mwebzone': {
wbzone = `╭──❍ *Webzone Menu*
...
│
╰────❍`
            await papah.sendButtonText(m.chat, wbzone, nyoutube, m, {quoted: fkontak})
            }
            break
            case 'menugenshin': {
...
│
╰────❍`
            await papah.sendButtonText(m.chat, dwnloader, nyoutube, m, {quoted: fkontak})
            }
            break
            case 'msearch': {
sarch = `╭──❍ *Search Menu*
...
│
╰────❍`
            await papah.sendButtonText(m.chat, sarch, nyoutube, m, {quoted: fkontak})
            }
            break
            case 'mrandom': {
rndom = `╭──❍ *Random Menu*
...
│
╰────❍`
            await papah.sendButtonText(m.chat, rndom, nyoutube, m, {quoted: fkontak})
            }
            break
            case 'mtextpro': {
...
│
╰────❍`
            await papah.sendButtonText(m.chat, txtpro, nyoutube, m, {quoted: fkontak})
            }
            break
            case 'mphotooxy': {
...
│
╰────❍`
            await papah.sendButtonText(m.chat, potooxy, nyoutube, m, {quoted: fkontak})
            }
            break
            case 'mephoto': {
ehoto = `╭──❍ *Ephoto Menu*
...
│
╰────❍`
            await papah.sendButtonText(m.chat, ehoto, nyoutube, m, {quoted: fkontak})
            }
            break
           case 'mfun': {
mun = `╭──❍ *Fun Menu*
...
│
╰────❍`
            await papah.sendButtonText(m.chat, mun, nyoutube, m, {quoted: fkontak})
            }
            break
            case 'mprimbon': {
pimbon = `╭──❍ *Primbon Menu*
...
│
╰────❍`
            await papah.sendButtonText(m.chat, pimbon, nyoutube, m, {quoted: fkontak})
            }
            break
            case 'mconvert': {
cnvert = `╭──❍ *Convert Menu*
...
│
╰────❍`
            await papah.sendButtonText(m.chat, cnvert, nyoutube, m, {quoted: fkontak})
            }
            break
            case 'mmain': {
min = `╭──❍ *Main Menu*
...
│
╰────❍`
            await papah.sendButtonText(m.chat, min, nyoutube, m, {quoted: fkontak})
            }
            break
            case 'mdatabase': {
...
│
╰────❍`
            await papah.sendButtonText(m.chat, dtbase, nyoutube, m, {quoted: fkontak})
            }
            break
            case 'manonymous': {
...
│
╰────❍`
            await papah.sendButtonText(m.chat, aonymous, nyoutube, m, {quoted: fkontak})
            }
            break
            case 'mislamic': {
islmic = `╭──❍ *Islamic Menu*
...
│
╰────❍`
            await papah.sendButtonText(m.chat, islmic, nyoutube, m, {quoted: fkontak})
            }
            break
case 'mvoice': {
vice = `╭──❍ *Voice Changer*
...
│
╰────❍`
            await papah.sendButtonText(m.chat, vice, nyoutube, m, {quoted: fkontak})
            }
            break
            case 'mowner': {
oner = `╭──❍ *Owner Menu*
...
│
╰────❍`
            await papah.sendButtonText(m.chat, oner, nyoutube, m, {quoted: fkontak})
            }
            break
            case 'allmenu': {
            let ownernya = ownernomer + '@s.whatsapp.net'
            let me = m.sender
            let ments = [ownernya, me, ini_mark]
            papah.sendMessage(m.chat, { image: fs.readFileSync('./media/image/menu.jpg'), caption: `_*Hi Kak ${m.pushName} 👋.*_
...
_⫹⫺ Tahun Baru : ${jhari} Hari ${jjam} Jam ${jmenit} Menit ${jdetik} Detik_
_⫹⫺ Idul Fitri : ${hahari} Hari ${hajam} Jam ${hamenit} Menit ${hadetik} Detik_
_⫹⫺ Idul Adha : ${hihari} Hari ${hijam} Jam ${himenit} Menit ${hidetik} Detik_
_⫹⫺ Ultah Creator : ${rainhari} Hari ${rainjam} Jam ${rainmenit} Menit ${raindetik} Detik_
